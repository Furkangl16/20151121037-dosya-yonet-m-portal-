...
if ($gateKeeper->isUserLoggedIn()) {
    ...
    if ($setUp->getConfig("show_usermenu") == true ) { 
        ...
        if ($gateKeeper->isSuperAdmin()) {
            print " <li><a href=\"vfm-admin/\"><i class=\"fa fa-cogs\"></i> "
        ...
        if ($gateKeeper->isSuperAdmin()) {
            echo " <a class=\"pull-right btn btn-primary btn-sm\" href=\"vfm-admin/\"><i class=\"fa fa-cogs\"></i> "
...
if ($setUp->showLangMenu()) { ?>
    ...
    if ($islogin == true) { 
        ...
        print ($encodeExplorer->printLangMenu('vfm-admin/'))."</li>";
    }
} ?>
    </div> <!-- .vfm-wrapper -->
</div> <!-- .topbanner -->
